...
const AdminProduct = () => {
  ...
  useEffect(() => {
    setState({
      ...
      image: product.image ? product.image : "https://i.imgur.com/f1I4xIg.jpg",
      ...
      <div className="container">
        ...
        <div className="product">
            ...
            <div className="productTopRight">
              <div className="productInfoTop">
                <img
                  ...
                  alt="https://imgur.com/lhLYKao"
                  className="productInfoImg"
                />
                <div className="productInfoBottom">
                  <span className="productName">{product && product.name}</span>
                  <h3 className="productInfoValue">
                    {product && product.price}
                  </h3>
                  <span className="productInfoKey">tipo de animal: </span>
                  <h5 className="productInfoValue">
                    {product && product.animalCategory}
                  </h5>
          ...
          <div className="productBottom">
            <form onSubmit={(e) => hundleOnSubmit(e)} className="productForm">
              <div className="productFormLeft">
                ...
                <button className="productAddButton" type="submit">
                  Modificar
                </button>
              </div>
            </form>
