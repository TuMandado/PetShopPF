...
export const UserSettings = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (input.name.search(/^[^$%&|<>#]*$/)) {
      return Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "Por favor, ingrese un nombre del dueño. ¡Solo debe contener letras!",
      ...
      return Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "Por favor, ingrese un email adecuado.",
        showConfirmButton: true,
      });
    } else if (
      input.phoneNumber < 1 ||
      input.phoneNumber.search(
  ...
  if (!user) {
    return Swal.fire({
      title: "¡Logueate!",
      text: "Para modificar un perfil, debes estar registrado o logeado. ¿Deseas iniciar sesión?",
      icon: "warning",
